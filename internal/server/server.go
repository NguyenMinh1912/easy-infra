...
func (s *Server) Handler() http.Handler {
	...
	mux.HandleFunc("GET /api/workspaces/{id}/export", s.handleExportWorkspace)
	...
	mux.HandleFunc("GET /api/profiles/{name}/services/{service}/info", s.handleJenkinsInfo)
	...
	mux.HandleFunc("PUT /api/templates/{name}", s.handleUpdateTemplate)
